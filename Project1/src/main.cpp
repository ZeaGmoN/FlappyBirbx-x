...
public:
    Bird() {
        ...
        for (const auto& path : {
            "resource/textures/bird/1-2.png",
            "resource/textures/bird/1-3.png",
            "resource/textures/bird/1-2.png",
            "resource/textures/bird/1-1.png",
            }) {
...
void setup() {
    ...
    font = new sf::Font();
    font->loadFromFile("resource/fonts/04B_19__.TTF");
    ...
    backgroundTexture->loadFromFile("resource/textures/background/day.png");

    groundTexture = new sf::Texture();
    groundTexture->loadFromFile("resource/textures/ground.png");

    upperPipe = new sf::Texture();
    lowerPipe = new sf::Texture();

    sf::Image pipeImage;
    pipeImage.loadFromFile("resource/textures/pipe.png");
